...
<body>
	...
	<div id="nav">
		<ul>
			...
			<li><input type="submit" class="active" value="Edit Movie"></li>
	...
	<form id="#edit-movie" action="/api/v1/movies" method="post">
		<table>
			<tr>
	    ...
	    <input class="hidden" type="text" name="action" size="20" value="editMovie">
